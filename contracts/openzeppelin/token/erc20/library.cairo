...
from starkware.cairo.common.uint256 import Uint256, uint256_check, uint256_eq, uint256_not, uint256_le
...
namespace ERC20:
    ...
    func _mint{
        ...
        if caller != owner:
            with_attr error_message("Lame ERC20: Only owner can mint more than 100 tokens per address"):
